export default {
  error: {
    ...
    login: {
      ...
      too_many_requests:
        'Kami minta maaf. Terlalu banyak permintaan saat ini. Mohon untuk jalankan ulang halaman dan coba lagi. Jika masih belum bisa, mohon coba lagi nanti.',
      session_missing:
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception:
        'Mohon setujui Persyaratan Layanan di bawah ini untuk melanjutkan.'
    }
  },
  success: {
  ...
  captchaCodeInputPlaceholder: 'Masukkan kode yang ditampilkan diatas',
