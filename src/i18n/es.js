export default {
  error: {
    forgotPassword: {
      too_many_requests:
        'Ha alcanzado el límite de intentos para restablecer su contraseña. Por favor, espere unos minutos antes de intentarlo de nuevo.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception:
        'Por favor, acepte los Términos de Servicio que están a continuación para continuar.'
    }
  },
  success: {
  ...
  captchaCodeInputPlaceholder: 'Introduzca el código mostrado arriba',
  captchaMathInputPlaceholder: 'Resuelve la fórmula mostrada arriba',
  ...
  passwordStrength: {
    ...
    nonEmpty: 'No se permite una contraseña vacía',
  ...
  passwordlessEmailAlternativeInstructions:
    'También puede ingresar su email para iniciar sesión<br/>o registrarse',
  ...
  passwordlessSMSAlternativeInstructions:
    'También puede ingresar su teléfono para iniciar sesión<br/>o registrarse',
